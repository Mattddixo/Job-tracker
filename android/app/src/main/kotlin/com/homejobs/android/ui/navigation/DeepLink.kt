...
sealed interface IncomingDeepLink {
    /** `hometracker://newjob?title=...&category=...&sourceId=...&estimatedMinutes=...&scheduledDate=...` -
     * [estimatedMinutes] and [scheduledDate] are both optional, carried over only when Job Jar
     * had them set on the job being sent. */
    data class CreateJob(
        val title: String?,
        val category: String?,
        val sourceJobJarId: Long?,
