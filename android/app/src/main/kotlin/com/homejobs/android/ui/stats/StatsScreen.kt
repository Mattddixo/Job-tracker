...
fun StatsScreen(
    ...
    Scaffold(
        topBar = {
            TopAppBar(
                title = { Text(if (showManage) "Manage Payment Methods" else "Stats") },
                navigationIcon = {
                    IconButton(onClick = { if (showManage) showManage = false else onBack() }) {
                ...
                actions = {
                    if (!showManage) {
                        IconButton(onClick = { showManage = true }) {
                            Icon(Icons.Filled.Edit, contentDescription = "Manage payment methods")
                        }
                    }
                },
            )
